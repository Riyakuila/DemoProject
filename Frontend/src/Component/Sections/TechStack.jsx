  ...
  return (
    <section className="relative overflow-hidden bg-[#101010] px-5 py-16 text-white">
      ...
      <div className="relative mx-auto max-w-7xl">
          ...
          {stacks.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="rounded-2xl border border-yellow-500/30 bg-[#0a0a0a] p-5 shadow-[0_0_25px_rgba(251,191,36,0.10)]"
              >
                <div className="flex items-start gap-4">

                  <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full border border-yellow-500/60 bg-yellow-500/5">
                  ...
                  <div>
                    ...
                    <span className="mt-2 block h-[3px] w-10 bg-gradient-to-r from-orange-400 to-yellow-500" />
        ...
        <div className="mt-8 grid gap-6 rounded-2xl border border-yellow-500/50 bg-black/80 p-7 shadow-[0_0_45px_rgba(251,191,36,0.16)] lg:grid-cols-[1.7fr_repeat(4,1fr)]">

          <div className="flex items-center gap-6">

            <div className="relative flex h-28 w-28 shrink-0 items-center justify-center rounded-full border border-yellow-500/40 shadow-[0_0_30px_rgba(251,191,36,0.28)]">

              <div className="absolute h-20 w-20 rounded-full border border-yellow-500/60" />

              <HiOutlineCodeBracket className="text-6xl text-yellow-500 drop-shadow-[0_0_18px_rgba(251,191,36,0.8)]" />
            </div>
          ...
          {features.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="flex gap-5 border-yellow-500/30 lg:border-l lg:pl-9"
              >
                <Icon className="mt-1 shrink-0 text-5xl text-yellow-500" />
