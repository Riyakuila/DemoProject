                  ...
                  <div className="relative h-full rounded-3xl transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                    <div className="absolute inset-0 rounded-3xl border border-white/10 bg-white/[0.035] p-6 [backface-visibility:hidden]">
                      ...
                      <button
                        ...
                        className="mt-6 flex items-center gap-2 text-sm font-bold text-orange-400"
                      >
                        Apply Now  
                      </button>
                    </div>
                    ...
                    <div className="absolute inset-0 rounded-3xl border border-orange-500/50 bg-[#090909] p-6 shadow-[0_0_40px_rgba(249,115,22,0.22)] [backface-visibility:hidden] [transform:rotateY(180deg)]">
                      ...
                      <button
                        onClick={() => openForm(role.title)}
                        className="mt-5 flex items-center gap-2 text-sm font-bold text-orange-400"
                      >
                        Apply Now 
                      </button>
                    </div>
            ...
            >
              {applyPoints.map((item, index) => (
                <motion.div
                  ...
                  whileHover={{ x: 12, scale: 1.02 }}
                  transition={{ type: "spring", stiffness: 260, damping: 18 }}
                  className="group flex items-center gap-5 rounded-3xl border border-orange-300/20 bg-white/[0.03] p-5 shadow-[0_0_18px_rgba(249,115,22,0.08)] transition hover:bg-white/[0.06]"
                >
                  <div className={iconBox}>
                  ...
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.19em] text-neutral-300">
                      Step {index + 1}
                    </p>
                      ...
                      <div className="grid min-w-0 gap-5 md:grid-cols-2">
                        ...
                        <div className="group min-w-0 space-y-1.5">
                          ...
                          <select
                            ...
                            className={`w-full min-w-0 rounded-2xl border bg-white/[0.04] px-4 py-3 text-white outline-none transition duration-300 hover:border-orange-500/60 hover:bg-white/[0.06] focus:border-orange-500 focus:bg-white/[0.07] focus:ring-2 ${
                              errors.position
  ...
  return (
    <div className="group min-w-0 space-y-1.5">
      ...
      <input
        ...
        className={`w-full min-w-0 rounded-2xl border bg-white/[0.04] px-4 py-3 text-white placeholder:text-neutral-600 outline-none transition duration-300 hover:border-orange-500/60 hover:bg-white/[0.06] focus:border-orange-500 focus:bg-white/[0.07] focus:ring-2 ${
          error
            ? "border-red-500 focus:ring-red-500/20"
            : "border-white/10 focus:ring-orange-500/20"
        }`}
