...
// const benefits = [
//   { title: "Real Projects", icon: Rocket, desc: "Work on live company projects and learn practical development." },
//   { title: "Mentorship", icon: Users, desc: "Get guidance from experienced developers and team members." },
//   { title: "Growth Culture", icon: Target, desc: "Improve your skills with modern tools, tasks, and teamwork." },
//   { title: "Friendly Team", icon: HeartHandshake, desc: "Work in a supportive learning environment." },
// ];
...
//     about: "Build clean, responsive, and modern user interfaces using React and Tailwind CSS.",
//   },
//   {
//     title: "Backend Developer Intern",
//     icon: Briefcase,
//     skills: ["Node.js", "API", "Database"],
//     about: "Work on APIs, database connections, server logic, and secure backend features.",
//   },
//   {
//     title: "UI/UX Designer Intern",
//     icon: Palette,
//     skills: ["Figma", "Wireframe", "Design"],
//     about: "Create user-friendly layouts, wireframes, and clean designs for digital products.",
//   },
//   {
//     title: "AI / ML Intern",
//     icon: Brain,
//     skills: ["Python", "ML", "Automation"],
//     about: "Learn to build smart automation, ML models, and AI-based project features.",
//   },
//   {
//     title: "Digital Marketing Intern",
//     icon: Megaphone,
//     skills: ["SEO", "Content", "Social Media"],
//     about: "Work on SEO, content planning, social media growth, and online brand presence.",
//   },
//   {
//     title: "Software Trainee",
//     icon: GraduationCap,
//     skills: ["Problem Solving", "Projects", "Learning"],
//     about: "Improve coding basics, problem solving, project building, and team collaboration.",
//   },
// ];
...
//   return (
//     <section className="relative min-h-screen overflow-hidden bg-black px-5 pb-24 pt-32 text-white md:px-20">
...
//             work on real digital products, AI solutions, and modern software projects.
//           </p>
...
//                 viewport={{ once: true }}
//                 className="group rounded-3xl border border-white/10 bg-white/[0.035] p-6 transition-all duration-300 hover:border-orange-500/70 hover:bg-orange-500/10 hover:shadow-[0_0_35px_rgba(249,115,22,0.2)]"
//               >
//                 <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-orange-500/60 bg-orange-500/10 text-orange-400 shadow-[0_0_18px_rgba(249,115,22,0.35)] transition-all duration-300 group-hover:border-white group-hover:bg-white group-hover:text-black group-hover:shadow-[0_0_35px_rgba(255,255,255,0.8)]">
//                   <Icon size={26} />
//                 </div>
...
//               These roles are perfect for learners who want practical exposure
...
//                   viewport={{ once: true }}
//                   className="group h-[275px] [perspective:1000px]"
//                 >
...
//                       <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-orange-500/60 bg-orange-500/10 text-orange-400 shadow-[0_0_18px_rgba(249,115,22,0.35)] transition-all duration-300 group-hover:border-white group-hover:bg-white group-hover:text-black group-hover:shadow-[0_0_35px_rgba(255,255,255,0.8)]">
//                         <Icon size={26} />
//                       </div>
...
//                 viewport={{ once: true }}
//                 >
//                 <p className="text-2xl font-semibold uppercase tracking-[0.04em] text-orange-400">
//                     Join Driksha
//                 </p>

//                 <h2 className="mt-7 max-w-2xl text-3xl font-black leading-tight md:text-4xl">
//                     Ready To Start Your Career With Real Work?
//                 </h2>

//                 <p className="mt-5 max-w-xl text-1xl leading-7 text-neutral-300">
//                     Share your resume and portfolio with us. Our team will review your
//                     skills and connect with you for the next step.
//                 </p>
...
//                         className="group flex items-center gap-9 rounded-3xl border border-orange-300/20 bg-white/[0.03] p-5 shadow-[0_0_18px_rgba(249,115,22,0.08)] transition hover:border-white/0 hover:bg-white/[0.06] hover:shadow-[0_0_30px_rgba(255,255,255,0.12)]"
//                     >
//                         <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-orange-500/60 bg-orange-200/10 text-orange-400 shadow-[0_0_18px_rgba(249,115,22,0.35)] transition-all duration-300 group-hover:border-white group-hover:bg-white group-hover:text-black group-hover:shadow-[0_0_35px_rgba(255,255,255,0.8)]">
...
//                         <ArrowRight
//                         size={18}
//                         className="ml-auto text-neutral-500 transition group-hover:translate-x-1 group-hover:text-white"
//                         />
//                     </motion.div>
//                     ))}
//                 </div>
